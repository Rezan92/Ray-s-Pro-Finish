...
const testimonialsData: Testimonial[] = [
    ...
    {
        id: 2,
        quote: "A wonderful serenity has taken possession of my entire soul, like these sweet mornings of spring which I enjoy with my whole heart. I am alone, and feel the charm of existence in this spot.",
        author: 'Jane Doe',
        role: 'CLIENTS',
    ...
    {
        id: 3,
        quote: "The quick, brown fox jumps over a lazy dog. DJs flock by when MTV ax quiz prog. Junk MTV quiz graced by fox whelps. Bawds jog, flick quartz, vex nymphs.",
        author: 'John Smith',
        role: 'PARTNERS',
