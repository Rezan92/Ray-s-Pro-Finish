export const PAINTING_TOOLTIPS = {
	ROOM_BUILDER:
	...
	CUSTOMIZE_ROOM:
		'This room is using the Global Project Defaults for surfaces, condition, and colors. Check the box to override these settings specific to this room.',
	...
	CEILING_POPCORN:
		"Popcorn ceilings are fragile. They require 'non-bridging' paint and a slower application to prevent the texture from falling off.",
	DOOR_PANELED:
