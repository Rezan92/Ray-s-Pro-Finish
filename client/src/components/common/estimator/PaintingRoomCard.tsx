...
export const PaintingRoomCard: React.FC<PaintingRoomCardProps> = ({
	...
	return (
		<div
			className={`${styles.roomCard} ${room.isCustomized ? styles.customized : ''}`}
		>
			{/* --- Card Header --- */}
			<button
				type='button'
			...
			<div className={`${styles.collapseWrapper} ${isOpen ? styles.open : ''}`}>
				<div className={styles.collapseInner}>
					<div className={styles.accordionContent}>
								...
								>
									...
									{!room.isCustomized && (
										<span className={styles.inheritanceLabel}>
											Following Project Defaults
										</span>
									)}
								</label>
								<div
									className={`${styles.checkboxGroupHorizontal} ${!room.isCustomized ? styles.ghosted : ''}`}
								>
									<label className={styles.checkboxLabel}>
										<input
											type='checkbox'
						...
						{showDetails && (
							<div className={styles.formGroupBox}>
								<div
									className={`${styles.conditionalFieldsContainer} ${!room.isCustomized ? styles.ghosted : ''}`}
								>
									{room.surfaces.ceiling && (
										<div className={styles.formGroup}>
											<div
						...
						<div className={styles.formGroupBox}>
							<div
								className={`${styles.formGroupGrid} ${!room.isCustomized ? styles.ghosted : ''}`}
							>
								<div className={styles.formGroup}>
									<label
										style={{
