...
| Other | 0.5 | 2.5 | 3.5 | 6.5 |
    ...
    * Crown Molding (surfaces.crownMolding):
        * Add +30% of Baseline Hours.
        * If *crownMoldingStyle* is 'Ornate', multiply *crown molding hours* by 1.5x.
    ...
    * Room Specifics (For 'Other'):
        * If *type* is 'other', pay close attention to *roomDescription*. 
        * If the description implies high complexity (e.g. "Library with built-ins"), adjust baseline hours upwards slightly.
        * If the description implies simplicity (e.g. "Small Pantry"), stick to the low baseline.
    ...
    * Ignored Services:
    ...
    7.  explanation: Write a brief, user-friendly breakdown of the costs.
        ...
        * For each component (e.g., "Wall Painting", "Ceiling Painting", "Trim & Baseboards", "Crown Molding", "Doors", "Furniture Moving", "Paint Materials"), show the approximate cost. You can derive this from the hours and material costs you calculated.
