...
export const PAINT_PRICES = {
	...
	SURCHARGES: {
		...
		OCCUPANCY_HANDLING_FLAT: 35,
		HIGH_CEILING_EQUIPMENT_DAILY: 200,
	},
};

export const LABOR_MULTIPLIERS = {
	SETUP_PER_ROOM: 0.5,
	OCCUPANCY_HANDLING_PER_ROOM: 0.75,
	CEILING_HEIGHT_FACTORS: { STANDARD: 1, MID: 1.25, HIGH: 1.5 },
	WALLS: 0.0125,
	WALL_PRIMING: 0.005,
	CEILING: 0.01,
	TRIM: 0.05,
...
export const PAINT_COVERAGE = {
	// Baseline yields per single coat
	WALL_SQFT_PER_GALLON: 350,
	CEILING_SQFT_PER_GALLON: 350,
	TRIM_LF_PER_GALLON: 700,
	DOOR_PER_GALLON: 8, // Both sides
	WINDOW_PER_GALLON: 12,
